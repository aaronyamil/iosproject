//
//  FemaleTableViewController.swift
//  FindSmartPeople
//
...
class FemaleTableViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier("FemaleCell", forIndexPath: indexPath) as! FemaleTableViewCell
    ...
    func loadPeople() {
        ...
        // populate using Rest
        Alamofire.request(.GET, "http://api.randomuser.me/?results=10&gender=female")
